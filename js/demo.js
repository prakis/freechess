...
$(document).ready(function () {
  ...
  var showColorsForImage = function($image, $imageSection ) {
    ...
    var palette                  = colorThief.getPalette(image, 10, 1);
...
$(".userselfile").change(function(){
	 ...
	 //console.log("jquery-inside-demo2.js-2-:"+ $('.userselfile')[0].files);
	 //console.log("jquery-inside-demo2.js-2-length:"+ $('.userselfile')[0].files.length);
	 var ufiles = $('.userselfile')[0].files;
		if(ufiles.length > 0){
			handleFiles(ufiles);
		}
	});
